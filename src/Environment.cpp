...
namespace lisp {
std::optional<Value>
Environment::Get(const std::string &name) const noexcept {
...
void
Environment::Combine(const Environment &other) noexcept {
...
void
Environment::Set(const std::string name, const Value value) noexcept {
