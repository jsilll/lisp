...
namespace lisp::std
{
    static void EvalArgs(::std::vector<Value> &args, const Environment &env)
    {
        for (auto &arg : args)
        {
            arg = arg.Eval(env);
    ...
    static Value Lambda(::std::vector<Value> args, const Environment &env)
    {
        if (args.size() < 2)
        {
    ...
    static Value Map(::std::vector<Value> args, const Environment &env)
    {
        EvalArgs(args, env);
    ...
    static Value Zip(::std::vector<Value> args, const Environment &env)
    {
        EvalArgs(args, env);
        ...
        else
        {
            ...
            {
                result.push_back(Value({args[0].list_data()[i], args[1].list_data()[i]}));
            }
            return Value(result);
        }
    }

    static Value Fold(::std::vector<Value> args, const Environment &env)
    {
        EvalArgs(args, env);
    ...
    static Value Filter(::std::vector<Value> args, const Environment &env)
    {
        EvalArgs(args, env);
    ...
    static Value If(::std::vector<Value> args, const Environment &env)
    {
        if (args.size() != 3)
        {
            throw ::std::runtime_error("Number of arguments must be 3");
        ...
        else
        {
            ...
            {
                throw ::std::runtime_error("Condition must be of type int, float, or string");
            }
        }
    }

    static Value Let(::std::vector<Value> args, const Environment &env)
    {
        if (args.size() != 2)
        {
            throw ::std::runtime_error("Number of arguments must be 2");
        ...
        else
        {
            ...
            {
                throw ::std::runtime_error("First argument must be a list of size 2");
            }
    ...
    static Value Plus(const Value &lhs, const Value &rhs)
    {
        if (lhs.type() == Type::Int)
        {
            ...
            {
                throw ::std::runtime_error("Cannot add numeric and non-numeric values");
            }
        }
    ...
    static Value Plus(::std::vector<Value> args, const Environment &env)
    {
        EvalArgs(args, env);
    ...
    static Value Minus(const Value &lhs, const Value &rhs)
    {
        if (lhs.type() == Type::Int)
        {
            if (rhs.type() == Type::Int)
            ...
            {
                throw ::std::runtime_error("Cannot subtract numeric and non-numeric values");
            }
        }
        else if (lhs.type() == Type::Float)
        {
    ...
    static Value Minus(::std::vector<Value> args, const Environment &env)
    {
        EvalArgs(args, env);
    ...
    static Value Times(const Value &lhs, const Value &rhs)
    {
        if (lhs.type() == Type::Int)
        {
            if (rhs.type() == Type::Int)
            ...
            {
                throw ::std::runtime_error("Cannot multiply numeric and non-numeric values");
            }
        }
        else if (lhs.type() == Type::Float)
        {
    ...
    static Value Times(::std::vector<Value> args, const Environment &env)
    {
        EvalArgs(args, env);
    ...
    static Value Divide(const Value &lhs, const Value &rhs)
    {
        if (rhs.type() == Type::Int)
        {
            ...
            {
                throw ::std::runtime_error("Cannot divide numeric and non-numeric values");
            }
        }
        else if (rhs.type() == Type::Float)
        {
    ...
    static Value Divide(::std::vector<Value> args, const Environment &env)
    {
        EvalArgs(args, env);
    ...
    static Value Equals(::std::vector<Value> args, const Environment &env)
    {
        EvalArgs(args, env);
        ...
        else if (args[0].type() == Type::Int)
        {
            ...
            {
                return args[0].stack_data().i == args[1].stack_data().i ? Value(1) : Value(0);
            }
            else if (args[1].type() == Type::Float)
            {
                return args[0].stack_data().i == args[1].stack_data().f ? Value(1) : Value(0);
            }
            else
            {
                throw ::std::runtime_error("Cannot compare numeric and non-numeric values");
            }
        }
        else if (args[0].type() == Type::Float)
        {
            if (args[1].type() == Type::Int)
            {
                return args[0].stack_data().f == args[1].stack_data().i ? Value(1) : Value(0);
            }
            else if (args[1].type() == Type::Float)
            {
                return args[0].stack_data().f == args[1].stack_data().f ? Value(1) : Value(0);
            }
            else
            {
                throw ::std::runtime_error("Cannot compare numeric and non-numeric values");
        ...
        else if (args[0].type() == Type::String)
        {
            ...
            {
                return args[0].string_data() == args[1].string_data() ? Value(1) : Value(0);
            }
            else
            {
                throw ::std::runtime_error("Cannot compare string and non-string values");
            }
        }
        ...
        {
            throw ::std::runtime_error("Only numeric and string values can be compared");
        }
    }

    static Value NotEquals(::std::vector<Value> args, const Environment &env)
    {
        EvalArgs(args, env);
    ...
    static Value Less(::std::vector<Value> args, const Environment &env)
    {
        EvalArgs(args, env);
    ...
    static Value Greater(::std::vector<Value> args, const Environment &env)
    {
        EvalArgs(args, env);
    ...
    static Value LessEquals(::std::vector<Value> args, const Environment &env)
    {
        EvalArgs(args, env);
    ...
    static Value GreaterEquals(::std::vector<Value> args, const Environment &env)
    {
        EvalArgs(args, env);
    ...
    static Value Abs(::std::vector<Value> args, const Environment &env)
    {
        EvalArgs(args, env);
    ...
    static Value Odd(::std::vector<Value> args, const Environment &env)
    {
        EvalArgs(args, env);
        ...
        {
            return static_cast<int>(args[0].stack_data().f) % 2 != 0 ? Value(1) : Value(0);
        }
        else
        {
            throw ::std::runtime_error("Argument must be an int or float");
    ...
    static Value Even(::std::vector<Value> args, const Environment &env)
    {
        EvalArgs(args, env);
    ...
    static Value Upper(::std::vector<Value> args, const Environment &env)
    {
        EvalArgs(args, env);
    ...
    static Value Lower(::std::vector<Value> args, const Environment &env)
    {
        EvalArgs(args, env);
    ...
    static Value ToStr(::std::vector<Value> args, const Environment &env)
    {
        EvalArgs(args, env);
    ...
    static Value Head(::std::vector<Value> args, const Environment &env)
    {
        EvalArgs(args, env);
    ...
    static Value Tail(::std::vector<Value> args, const Environment &env)
    {
        EvalArgs(args, env);
    ...
    static Value Range(::std::vector<Value> args, const Environment &env)
    {
        EvalArgs(args, env);
